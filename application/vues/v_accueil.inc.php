<section>
    <div id="article_autre">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn btn-primary" href="index.php?controleur=news&action=ecrireNews" id="btn-ajout-news" >Ecrire une news</a>
                </div>
            </div>        
            <?php } ?>
            ...
            foreach (VariablesGlobales::$lesNews as $uneNews) {
                ...
                <div class="row" style="border-top: 1px solid #c0c0c0; margin-top: 8px;">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="row">
                            <aside class="col-lg-12" style="margin-top: 25px;">
                                <form action="index.php?controleur=news&action=supprNewsFromAccueil" method="post">
